...
import cz.steiner.sql.InterSystemsIRISJoinFragment;
...
import cz.steiner.dialect.identity.InterSystemsIRISIdentityColumnSupport;
...
import cz.steiner.exception.internal.InterSystemsIRISSQLExceptionConversionDelegate;
...
*/
	...
	/**
	 *
	 * Actually, it does not support sequences, BUT
	 * IRIS Data platform has an global variables,
	 * and i can call an stored procedure which return be back, next value
	 * sequenceName will be actiually name of the stored procedure which will return next value
	 *
	...
	public String getSequenceNextValString(String sequenceName) throws MappingException {
		return "select  GET".concat(sequenceName).concat("SERIAL").concat("()");
...
//		throw new MappingException( getClass().getName() + " does not support sequences" );
  ...
  return "CREATE PROCEDURE GET".concat(sequenceName.toUpperCase()).concat("SERIAL()\n" +
		  "RETURNS INTEGER\n" +
		  "LANGUAGE OBJECTSCRIPT\n" +
		  "{\n" +
		    "QUIT $SEQ(^"+sequenceName.toUpperCase().replace("_","")+"GENER)"+
		  "}");
//		throw new MappingException( getClass().getName() + " does not support sequences" );
	}
	...
	protected String getDropSequenceString(String sequenceName) throws MappingException {
		...
		//TODO
		return "DROP GET".concat(sequenceName.toUpperCase()).concat("SERIAL");
//		throw new MappingException( getClass().getName() + " does not support sequences" );
	}
	...
	public String getQuerySequencesString() {
		return " SELECT SPECIFIC_NAME FROM INFORMATION_SCHEMA.ROUTINES\n" +
				" where SPECIFIC_NAME like 'GET%SERIAL'";
	}
